...
public class AdvancedLevel extends AppCompatActivity {
    ...
    private ImageView randomImg02; //Three image views
    private ImageView randomImg03;
    private EditText inputTxtOne;
    private EditText inputTxtTwo; // Three input text fields
    private EditText inputTxtThree;
    private TextView txtCorrectionOne;
    private TextView txtCorrectionTwo; //Three text correction textViews,If answers are incorrect,this fields used to display correct answer
    private TextView txtCorrectionThree;
    private TextView counterView; //Display marks of users gain in the game
    private TextView correctionOrIncorrection;
    private TextView marksTextView;
    private Button submitBtn;
    private int carOne;
    private int carTwo; //store randomly generated numbers
    private int carThree;
    private int greenColorValue = Color.parseColor("#23cc1b");  //
    private int redColorValue = Color.parseColor("#f01c05");    //colors
    private int defHintColorValue = Color.parseColor("#808080");//
    private int defTextColorValue = Color.parseColor("#000000");//
    private int attempts = 0;
    private int count; //store marks
    private String carModelOne="";
    private String carModelTwo=""; //store each car model generated by the array.
    private String carModelThree="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marksTextView = findViewById(R.id.textView_marks);
